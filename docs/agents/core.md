...
`tests/test_baum_welch.py` holds its 49 tests. The sixth is `_forward_backward.py`, the project's second dynamic-programming kernel, written 2026-09-14 on
